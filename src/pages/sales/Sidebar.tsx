...
export default function SalesSidebar() {
    ...
    return (
        <aside className={`
            ...
            w-72 bg-white dark:bg-[#111111] text-slate-600 dark:text-slate-400 border-r border-slate-200 dark:border-white/5 
        ...
        `}>
            <div className="flex flex-col">
                ...
                <nav className="p-4 flex flex-col gap-1">
                    <NavLink to="/sales" end onClick={closeMobileMenu} className={({ isActive }) => `flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive ? 'active-nav bg-primary/10 text-primary shadow-sm' : 'hover:bg-slate-100 hover:text-slate-900 dark:hover:text-white dark:hover:bg-white/5'}`}>
                        <span className="material-symbols-outlined">dashboard</span>
                        <span className="text-sm font-medium">Dashboard</span>
                    </NavLink>
                    <NavLink to="/sales/order-entry" onClick={closeMobileMenu} className={({ isActive }) => `flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive ? 'active-nav bg-primary/10 text-primary shadow-sm' : 'hover:bg-slate-100 hover:text-slate-900 dark:hover:text-white dark:hover:bg-white/5'}`}>
                        <span className="material-symbols-outlined">order_approve</span>
                        <span className="text-sm font-medium">Input & Kelola Pesanan</span>
                    </NavLink>
                    <NavLink to="/sales/visibility" className={({ isActive }) => `flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive ? 'active-nav bg-primary/10 text-primary shadow-sm' : 'hover:bg-slate-100 hover:text-slate-900 dark:hover:text-white dark:hover:bg-white/5'}`}>
                        <span className="material-symbols-outlined">visibility</span>
                        <span className="text-sm font-medium">Visibilitas Pesanan</span>
                    </NavLink>
                    <NavLink to="/sales/billing" className={({ isActive }) => `flex items-center justify-between px-4 py-3 rounded-lg transition-all ${isActive ? 'active-nav bg-primary/10 text-primary shadow-sm' : 'hover:bg-slate-100 hover:text-slate-900 dark:hover:text-white dark:hover:bg-white/5'}`}>
                        <div className="flex items-center gap-3">
                            <span className="material-symbols-outlined">receipt_long</span>
                            <span className="text-sm font-medium">Konfirmasi Penagihan</span>
                        </div>
            ...
            <div className="relative">
                        ...
                        <div className="p-5 border-b border-slate-200 dark:border-white/5">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="text-sm font-bold text-slate-900 dark:text-white">Admin Sales 1</p>
                                    <p className="text-[11px] text-slate-500 dark:text-slate-400 truncate">sales@logistics.com</p>
                                </div>
                            </div>
                        </div>
                        <div className="p-4">
                            ...
                            <div className="space-y-1">
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-sm font-bold">Admin Sales</span>
                                    </div>
                ...
                >
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                            <p className="text-sm font-semibold text-slate-900 dark:text-white truncate">Admin Sales 1</p>
                            <p className="text-xs text-slate-500 truncate">Sales Dept</p>
                        </div>
